...
namespace FlexibowlLibrary
{
    public class Flexibowl
    {
        ...
        public IPAddress FlexibowlIP { get; set; }
        public int FlexibowlPort { get; set; }


        public Flexibowl(string flexibowlIp, string flexibowlPort)
        {
            UdpClient = new UdpClient();
            FlexibowlIP = IPAddress.Parse(flexibowlIp);
            FlexibowlPort = int.Parse(flexibowlPort);
        }
        ...
        public bool Connect()
        {
            IPEndPoint endpoint = new IPEndPoint(FlexibowlIP, FlexibowlPort);
